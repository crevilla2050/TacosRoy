...
CREATE TABLE `tbl_costos_extra_var_prod` (
  ...
  KEY `fk_tbl_costos_extra_var_prod_1_idx` (`id_producto`),
  ...
  CONSTRAINT `fk_tbl_costos_extra_var_prod_1` FOREIGN KEY (`id_producto`) REFERENCES `tbl_productos` (`id_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tbl_costos_extra_var_prod` VALUES (1,167,2217,17,10,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=2219 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=542 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_variantes_platillos` VALUES (1,'Sin Salsa','Productos preparados no llevan salsa','S/Salsa',1),(2,'Sin Guacamole','Productos preparados no llevan guacamoles','S/Gua',1),(3,'Sin Verdura','Los platillos preparados no llevan verdura','S/Verd',1),(4,'Sin Cebolla','Los platillos preparados no llevan cebolla','S/Ceb',1),(5,'Sin Cilantro','Los platillos preparados no llevan cilantro','S/Cil',1),(6,'Sin Piña','Los platillos preparados no llevan piña','S/Piña',1),(7,'Pura Carne','Los platillos preparados llevan pura carne al natural','PCne',1),(8,'Sin Col','Los platillos preparados no llevan Col','S/Col',1),(9,'Sin Rábano','Los platillos preparados no llevan Rábano','S/Rab',1),(10,'Para llevar','Los productos son para llevar','PLLEV',1),(11,'Maciza de Puerco','El pozole lleva carne maciza de puerco','MacizaPco',1),(12,'Maciza de Res','El pozole lleva carne Maciza de Res','MacizaRes',1),(13,'Surtido Puerco','El pozole lleva carne surtida de puerco','SurtidaPco',1),(14,'Mixto Puerco y Res','El pozole lleva carne mixta de puerco y res','Mixto',1),(15,'Carne pastor','Para tacos o tostadas de paquete','Carne Pastor',1),(16,'Carne Puerco','Para tacos o tostadas de paquete','Carne Pco',1),(17,'A Domicilio','Producto a domicilio','Domic.',1),(18,'Tortilla Maiz','Producto con tortillas de maiz','Tt. Maiz',1),(19,'Tortilla Harina','Producto con tortillas de harina','Tt. Harina',1),(20,'Bistec Res','Producto preparado con Bistec de Res','C/BistecRes',1),(21,'De Costilla','Carne Costilla para los platillos a la plancha que lo requieran','c/Costilla',1),(22,'de Pollo','Carne de pollo para los platillos que lo requieren','c/Pollo',1),(24,'Chuleta','Con Chuleta para preparar el platillo a la plancha','c/Chuleta',1),(25,'Champiñones','Con Champiñones','c/Champñ',1);
...
--
-- Temporary table structure for view `vw_variantes_x_producto`
--

DROP TABLE IF EXISTS `vw_variantes_x_producto`;
/*!50001 DROP VIEW IF EXISTS `vw_variantes_x_producto`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `vw_variantes_x_producto` (
  `ID` tinyint NOT NULL,
  `ID Prod.` tinyint NOT NULL,
  `Producto` tinyint NOT NULL,
  `ID Var.` tinyint NOT NULL,
  `Variante` tinyint NOT NULL,
...
--
-- Final view structure for view `vw_variantes_x_producto`
--

/*!50001 DROP TABLE IF EXISTS `vw_variantes_x_producto`*/;
/*!50001 DROP VIEW IF EXISTS `vw_variantes_x_producto`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vw_variantes_x_producto` AS select `tbl_prods_variantes`.`id_prods_variantes` AS `ID`,`tbl_productos`.`id_producto` AS `ID Prod.`,`tbl_productos`.`chr_nombre_prod` AS `Producto`,`tbl_variantes_platillos`.`id_variante_pl` AS `ID Var.`,`tbl_variantes_platillos`.`chr_variante_nombre` AS `Variante`,`tbl_variantes_platillos`.`chr_imprimir` AS `Imprimir`,`tbl_prods_variantes`.`int_activo` AS `Activo` from ((`tbl_prods_variantes` left join `tbl_productos` on(`tbl_prods_variantes`.`id_producto` = `tbl_productos`.`id_producto`)) left join `tbl_variantes_platillos` on(`tbl_prods_variantes`.`id_variante` = `tbl_variantes_platillos`.`id_variante_pl`)) where `tbl_prods_variantes`.`int_activo` = 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-11-14 21:14:31
